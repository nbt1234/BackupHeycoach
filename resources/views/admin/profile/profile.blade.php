            ...
            @csrf
              <div class="avatar-upload">
                  ...
                  <div class="avatar-preview">
                      <div id="imagePreview" style="background-image: url({{ asset('/public/admin-assets/img/profile_img/') }}/{{$data->pro_img}});">
                      </div>
                  </div>
              </div>
            </form>            
        ...
        <div class="card">
          ...
          <div class="card-header p-2">
            <ul class="nav nav-pills">
              <li class="nav-item"><a class="nav-link {{Session::has('settings') ? '' : 'active'}}" href="#information" data-toggle="tab">Info</a></li>
              <li class="nav-item"><a class="nav-link {{Session::has('settings') ? 'active' : ''}}" href="#settings" data-toggle="tab">Settings</a></li>
            </ul>
          </div>
          <!-----/.Tab----->
          ...
          <div class="card-body">
            <div class="tab-content">                	
            	...
            	<!------Information Tab-------->
              <div class="tab-pane {{Session::has('settings') ? '' : 'active'}}" id="information">
                ...
                <div class="form-group row">
              	...
              	<!------Setting Tab-------->
              	<div class="tab-pane {{Session::has('settings') ? 'active' : ''}}" id="settings">
